...
MEM_0 := qsysP01_onchip_memory2_0
...
# Memory: sdram_control
MEM_1 := sdram_control
$(MEM_1)_NAME := sdram_control
...
$(MEM_1)_HIERARCHICAL_PATH := sdram_control
$(MEM_1)_WIDTH := 32
...
.PHONY: sdram_control
sdram_control: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
