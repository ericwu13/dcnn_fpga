...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../qsysP01.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x101010f8
SOPC_SYSID_FLAG += --sidp=0x101010f8
ELF_PATCH_FLAG  += --sidp 0x101010f8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1530972499
SOPC_SYSID_FLAG += --timestamp=1530972499
ELF_PATCH_FLAG  += --timestamp 1530972499
